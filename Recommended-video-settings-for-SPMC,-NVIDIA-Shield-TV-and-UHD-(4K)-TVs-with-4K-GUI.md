...
_"Yadif (2x)"_ is the best deinterlacing available on the Shield TV but, because it is not hardware accelerated, is best for SD resolution videos.  For HD videos, _"Bob"_ is the best deinterlacing for HD videox because it is hardware accelerated.
